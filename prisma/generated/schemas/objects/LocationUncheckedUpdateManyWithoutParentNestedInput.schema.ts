...
const Schema: z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutParentNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => LocationUpdateManyWithWhereWithoutParentInputObjectSchema,
          ),
          z
            .lazy(
              () => LocationUpdateManyWithWhereWithoutParentInputObjectSchema,
...
export const LocationUncheckedUpdateManyWithoutParentNestedInputObjectSchema =
  Schema;
