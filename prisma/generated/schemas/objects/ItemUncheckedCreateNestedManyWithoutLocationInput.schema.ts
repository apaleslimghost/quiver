...
const Schema: z.ZodType<Prisma.ItemUncheckedCreateNestedManyWithoutLocationInput> =
  z
    .object({
      create: z
        .union([
...
export const ItemUncheckedCreateNestedManyWithoutLocationInputObjectSchema =
  Schema;
