...
const Schema: z.ZodType<Prisma.ItemUpdateManyWithoutLocationNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ItemUpsertWithWhereUniqueWithoutLocationInputObjectSchema),
        z
          .lazy(() => ItemUpsertWithWhereUniqueWithoutLocationInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ItemUpdateWithWhereUniqueWithoutLocationInputObjectSchema),
        z
          .lazy(() => ItemUpdateWithWhereUniqueWithoutLocationInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ItemUpdateManyWithoutLocationNestedInputObjectSchema = Schema;
